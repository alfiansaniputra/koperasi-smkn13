...
if($foto == NULL) {
  ...
  echo "<tr>
      ...
      <td><img style='width: 20%; display: block;' src ='../barang/img/$foto' width=100 height=100 class='activator' ></td>
      <td><a href=\"../proses/delete_barang.php?no=$data[no]\">DELETE</a> | <a href=\"update_barang.php?no=$data[no]\">UPDATE</a>  <a href='detail.php?no=$data[no]'>DETAIL</a></td>
    </tr>";
    ?>
<?php
    $no++;
